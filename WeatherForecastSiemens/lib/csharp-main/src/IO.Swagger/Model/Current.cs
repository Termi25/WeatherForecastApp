...
namespace IO.Swagger.Model
{
        ...
        public partial class Current :  IEquatable<Current>, IValidatableObject
    {
        ...
        public Current(int? lastUpdatedEpoch = default(int?), string lastUpdated = default(string), decimal? tempC = default(decimal?), decimal? tempF = default(decimal?), int? isDay = default(int?), CurrentCondition condition = default(CurrentCondition), decimal? windMph = default(decimal?), decimal? windKph = default(decimal?), int? windDegree = default(int?), string windDir = default(string), int? pressureMb = default(int?), decimal? pressureIn = default(decimal?), double? precipMm = default(double?), int? precipIn = default(int?), int? humidity = default(int?), int? cloud = default(int?), int? feelslikeC = default(int?), decimal? feelslikeF = default(decimal?), int? visKm = default(int?), int? visMiles = default(int?), double? uv = default(double?), decimal? gustMph = default(decimal?), decimal? gustKph = default(decimal?), CurrentAirQuality airQuality = default(CurrentAirQuality))
        {
